...
describe('#breedDetails', () => {
  ...
  it('does not return breed details for the Calico breed', () => {
    const expectedDesc = "Calico are curious, outgoing, intelligent cats with excellent communication skills. They are known for their chatty personalities and are always eager to tell you their views on life, love, and what you’ve served them for dinner.";
    const calico = breedDetails('Calico');
    assert.notEqual(expectedDesc, calico);
    console.log(breedDetails);
  });
});
